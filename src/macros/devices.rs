...
macro_rules! sensor_commands {
    ( calibration_common ) => {
        ...
        pub fn set_calibration_clear(&self) -> Result<()> {
    ...
    ( device_common ) => {
        ...
        pub fn set_import_line(&self, import: &str) -> Result<()> {
        ...
        pub fn set_factory_reset(&self) -> Result<()> {
            let _reset = Factory
                .run(&mut self.i2cdev.borrow_mut())
                .chain_err(|| ErrorKind::SensorTrouble)?;
            Ok(())
        ...
        pub fn set_find_mode(&self) -> Result<()> {
        ...
        pub fn set_device_address(&self, address: u16) -> Result<()> {
        ...
        /// Turn off the LED.
        pub fn set_led_off(&self) -> Result<()> {
            let _set = LedOff
                .run(&mut self.i2cdev.borrow_mut())
                .chain_err(|| ErrorKind::SensorTrouble)?;
            Ok(())
        ...
        pub fn set_protocol_lock_off(&self) -> Result<()> {
        ...
        pub fn set_protocol_lock_on(&self) -> Result<()> {
    ...
    ( temperature_compensation ) => {
        ...
        pub fn set_compensation_temperature(&self, value: f64) -> Result<()> {
        ...
        pub fn get_compensated_temperature_value(&self) -> Result<CompensationValue> {
